...
def verificarID():
    ID=0
    ID1=input("Ingrese su nombre: ")
    ID2=input("Ingrese su DNI: ")
...
def gestionarCupones():
    ...
    if opcionNum == "0":
        ...
        if len(cuponesCodigo) == 0:
            ...
            borrarNum = int(input("Seleccione un cupón para borrar (Solo ingrese numeros): "))
        ...
        if len(cuponesCodigo) == 0:
            ...
            modificarNum = input("Seleccione un cupón para modificar (Solo numeros): ")

            if modificarNum == "0":
                return gestionarCupones()
            elif int(modificarNum)>0 and int(modificarNum)<=(len(cuponesCodigo)+1):
...
def mostrarMenu(ID, ID1):
    ...
    while seguirPrograma:
        if ID == 2:
            ...
            print("=======================================================================")
            print("Bienvenido a la tienda virtual 🏪 ADMIN", ID1)
            print("[1] Comprar 💲")
            ...
            print("E-Commerce⦿E-Commerce⦿E-Commerce⦿E-Commerce⦿E-Commerce⦿E-Commerce⦿")
            print("=======================================================================")
            print("Bienvenido a la tienda virtual 🏪", ID1)
            print("[1] Comprar 💲")
            print("[2] Salir ❌")
            opcion = input("Seleccione opción: ")
            if opcion == "1":
...
DniAdmin=["60470761", "1111", "2222", "3333"]
